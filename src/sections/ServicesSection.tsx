...
export default function ServicesSection() {
  return (
    <section
      id="skills"
      className="rounded-t-[30px] bg-white px-4 py-14 sm:rounded-t-[50px] sm:px-8 sm:py-24 md:rounded-t-[60px] md:px-10 md:py-32"
    >
      <h2
        className="mb-12 text-center font-black uppercase text-[#0C0C0C] sm:mb-20 md:mb-28"
